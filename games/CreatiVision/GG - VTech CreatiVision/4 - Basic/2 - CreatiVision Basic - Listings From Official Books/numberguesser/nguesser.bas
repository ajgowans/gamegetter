...
1010 PRINT L$
1020 PRINT"* WIZZARD  NUMBER  GUESSER *"
1030 PRINT L$
1040 PRINT
1045 PRINT
1050 PRINT"YOUR WIZZARD WILL THINK OF A"
1060 PRINT
1070 PRINT"NUMBER AND YOU HAVE TO TRY"
1080 PRINT
...
1180 PRINT L$
1190 PRINT
1200 PRINT"HOW HIGH CAN THE NUMBER BE"
1210 PRINT
1220 INPUT L
1230 GOSUB 9000
1240 X = RND(L) + I
...
3015 PRINT
3020 PRINTG;" IS THE CORRECT ANSWER"
3030 PRINT
3040 PRINT"AND IT ONLY TOOK YOU"
3050 PRINT
3055 IF K = 1 THEN 3070
3060 PRINT K;" GUESSES!  (RANGE: 1-";L;")"
3065 GOTO 3080
3070 PRINT K;" GUESS!!  (RANGE: 1-";L;")"
3080 SOUND 31;0
3085 SOUND 26;0
3090 SOUND 31;0
3095 SOUND 26;0
